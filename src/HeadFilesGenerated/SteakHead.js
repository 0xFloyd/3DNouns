...
const SteakHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSteak.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Steak' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSteak.glb');

export default SteakHead;
