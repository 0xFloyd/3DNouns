...
const LaptopHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Laptop' ? true : false} castShadow receiveShadow>
