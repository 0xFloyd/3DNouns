...
const WatermelonHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWatermelon.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Watermelon' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWatermelon.glb');

export default WatermelonHead;
