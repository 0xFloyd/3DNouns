...
const FlamingoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadFlamingo.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Flamingo' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadFlamingo.glb');

export default FlamingoHead;
