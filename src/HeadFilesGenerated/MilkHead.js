...
const MilkHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMilk.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Milk' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadMilk.glb');
