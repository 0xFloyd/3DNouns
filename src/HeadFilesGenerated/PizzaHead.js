...
const PizzaHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPizza.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pizza' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPizza.glb');
