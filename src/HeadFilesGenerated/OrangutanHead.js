...
const OrangutanHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/OrangutanHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Orangutan' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/OrangutanHead.glb');

export default OrangutanHead;
