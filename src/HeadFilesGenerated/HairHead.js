...
const HairHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadHair.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Hair' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadHair.glb');
