...
const FoxHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/FoxHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Fox' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/FoxHead.glb');
