...
const CapybaraHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/CapybaraHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Capybara' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/CapybaraHead.glb');
