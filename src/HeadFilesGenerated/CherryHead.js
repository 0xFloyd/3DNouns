...
const CherryHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCherry.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cherry' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCherry.glb');

export default CherryHead;
