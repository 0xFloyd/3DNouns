...
const DiamondblueHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadDiamondBlue.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Diamond-Blue' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadDiamondBlue.glb');

export default DiamondblueHead;
