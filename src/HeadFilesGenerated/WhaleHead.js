...
const WhaleHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWhale.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Whale' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWhale.glb');
