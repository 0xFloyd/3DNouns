...
const TornadoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadTornado.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Tornado' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadTornado.glb');
