...
const RobotHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/robotHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Robot' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/robotHead.glb');
