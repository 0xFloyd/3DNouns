...
const MountainHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMountain.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Mountain-Snowcap' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadMountain.glb');

export default MountainHead;
