...
const BigfootHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBigfoot.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bigfoot' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBigfoot.glb');

export default BigfootHead;
