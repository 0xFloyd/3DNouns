...
const QueenHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/queenHead.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Queen' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/queenHead.glb');

export default QueenHead;
