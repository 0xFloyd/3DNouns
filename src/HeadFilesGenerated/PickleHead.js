...
const PickleHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPickle.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pickle' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPickle.glb');

export default PickleHead;
