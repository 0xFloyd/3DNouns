...
const TreasureChestHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/TreasureChestHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Treasurechest' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/TreasureChestHead.glb');

export default TreasureChestHead;
