...
const GoatHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/goatHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Goat' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/goatHead.glb');

export default GoatHead;
