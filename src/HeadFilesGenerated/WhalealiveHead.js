...
const WhalealiveHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWhaleAlive.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Whale-Alive' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWhaleAlive.glb');

export default WhalealiveHead;
