...
const RulertriangularHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRulerTriangular.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Ruler-Triangular' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRulerTriangular.glb');

export default RulertriangularHead;
