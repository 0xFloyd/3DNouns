...
const ChefhatHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadChefHat.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Chefhat' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadChefHat.glb');

export default ChefhatHead;
