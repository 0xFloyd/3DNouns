...
const NoodlesHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/NoodlesHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Noodles' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/NoodlesHead.glb');

export default NoodlesHead;
