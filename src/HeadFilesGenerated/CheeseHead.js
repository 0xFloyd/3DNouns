...
const CheeseHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCheese.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cheese' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCheese.glb');
