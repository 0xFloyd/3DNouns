...
const PiggyHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPiggy.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Piggy' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/HeadPiggy.glb');

export default PiggyHead;
