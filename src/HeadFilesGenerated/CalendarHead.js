...
const CalendarHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCalendar.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Calendar' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCalendar.glb');
