...
const ScorpionHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadScorpion.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Scorpion' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadScorpion.glb');

export default ScorpionHead;
