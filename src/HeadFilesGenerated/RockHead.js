...
const RockHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRock.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Rock' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRock.glb');

export default RockHead;
