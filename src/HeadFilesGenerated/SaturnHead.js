...
const SaturnHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSaturn.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Saturn' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSaturn.glb');

export default SaturnHead;
