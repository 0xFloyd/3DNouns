...
const HockeypuckHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadHockeyPuck.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Hockeypuck' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadHockeyPuck.glb');

export default HockeypuckHead;
