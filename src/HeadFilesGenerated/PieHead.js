...
const PieHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPie.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pie' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPie.glb');

export default PieHead;
