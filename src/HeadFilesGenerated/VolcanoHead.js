...
const VolcanoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadVolcano.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Volcano' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadVolcano.glb');

export default VolcanoHead;
