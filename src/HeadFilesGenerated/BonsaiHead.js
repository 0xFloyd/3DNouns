...
const BonsaiHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBonsai.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bonsai' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBonsai.glb');

export default BonsaiHead;
