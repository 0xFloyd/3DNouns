...
const RingHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRing.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Ring' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRing.glb');
