...
const SpongeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSponge.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Sponge' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSponge.glb');

export default SpongeHead;
