...
const IglooHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadIgloo.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Igloo' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadIgloo.glb');

export default IglooHead;
