...
const BearHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBear.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bear' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBear.glb');
