...
const RoadHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRoad.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Road' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRoad.glb');
