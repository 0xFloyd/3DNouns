...
const ToothbrushHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadToothBrush.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Toothbrush-Fresh' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadToothBrush.glb');

export default ToothbrushHead;
