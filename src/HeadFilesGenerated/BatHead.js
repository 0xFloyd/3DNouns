...
const BatHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBat.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bat' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBat.glb');

export default BatHead;
