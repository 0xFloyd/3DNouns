...
const CordlessphoneHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCordlessphone.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cordlessphone' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCordlessphone.glb');

export default CordlessphoneHead;
