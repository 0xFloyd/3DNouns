...
const ConeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCone.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cone' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCone.glb');

export default ConeHead;
