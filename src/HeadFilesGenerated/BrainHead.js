...
const BrainHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBrain.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Brain' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBrain.glb');
