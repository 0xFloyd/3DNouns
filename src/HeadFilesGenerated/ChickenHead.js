...
const ChickenHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadChicken.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Chicken' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadChicken.glb');

export default ChickenHead;
