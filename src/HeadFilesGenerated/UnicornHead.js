...
const UnicornHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadUnicorn.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Unicorn' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadUnicorn.glb');
