...
const UfoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadUFO.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Ufo' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadUFO.glb');

export default UfoHead;
