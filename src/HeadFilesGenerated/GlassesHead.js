...
const GlassesHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadGlasses.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Glasses-Big' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadGlasses.glb');
