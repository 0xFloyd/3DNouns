...
const BubblegumHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBubbleGum.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bubblegum' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBubbleGum.glb');

export default BubblegumHead;
