...
const HouseHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadHouse.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'House' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadHouse.glb');
