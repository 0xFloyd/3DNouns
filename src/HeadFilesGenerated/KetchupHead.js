...
const KetchupHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadKetchup.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Ketchup' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadKetchup.glb');

export default KetchupHead;
