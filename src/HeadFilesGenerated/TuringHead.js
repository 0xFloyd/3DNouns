...
const TuringHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadTuring.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Turing' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadTuring.glb');

export default TuringHead;
