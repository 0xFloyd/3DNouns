...
const SnowmobileHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/SnowMobileHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Snowmobile' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/SnowMobileHead.glb');

export default SnowmobileHead;
