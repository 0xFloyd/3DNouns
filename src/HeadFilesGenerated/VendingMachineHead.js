...
const VendingMachineHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/VendingMachineHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Vending-Machine' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/VendingMachineHead.glb');

export default VendingMachineHead;
