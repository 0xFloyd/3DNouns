...
const SkiliftHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSkilift.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Skilift' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSkilift.glb');

export default SkiliftHead;
