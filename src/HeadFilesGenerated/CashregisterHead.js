...
const CashregisterHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCashRegister.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cash-Register' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCashRegister.glb');

export default CashregisterHead;
