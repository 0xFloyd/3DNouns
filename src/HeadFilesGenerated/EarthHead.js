...
const EarthHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadEarth.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Earth' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadEarth.glb');

export default EarthHead;
