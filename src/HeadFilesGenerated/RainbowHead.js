...
const RainbowHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRainbow.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Rainbow' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRainbow.glb');

export default RainbowHead;
