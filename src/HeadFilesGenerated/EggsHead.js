...
const EggsHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadEggs.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Egg' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadEggs.glb');

export default EggsHead;
