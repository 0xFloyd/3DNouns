...
const PotatoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPotato.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Potato' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPotato.glb');
