...
const FactoryHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadFactory.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Factory-Dark' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadFactory.glb');
