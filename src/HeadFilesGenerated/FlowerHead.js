...
const FlowerHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadFlower.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Flower' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadFlower.glb');
