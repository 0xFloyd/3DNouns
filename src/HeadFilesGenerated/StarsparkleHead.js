...
const StarsparkleHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadStarSparkle.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Star-Sparkles' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadStarSparkle.glb');

export default StarsparkleHead;
