...
const PandaHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPanda.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Panda' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPanda.glb');
