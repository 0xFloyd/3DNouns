...
const DogHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadDog.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Dog' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadDog.glb');
