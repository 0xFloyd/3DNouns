...
const PumpkinHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPumpkin.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pumpkin' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPumpkin.glb');
