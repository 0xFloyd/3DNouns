...
const OwlHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/owlHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Owl' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/owlHead.glb');
