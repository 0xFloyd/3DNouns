...
const WallsafeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWallSafe.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Wallsafe' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWallSafe.glb');

export default WallsafeHead;
