...
const LipstickHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadLipstick.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Lipstick2' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadLipstick.glb');

export default LipstickHead;
