...
const SkateHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/skateHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Skateboard' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/skateHead.glb');

export default SkateHead;
