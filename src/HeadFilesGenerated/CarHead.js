...
const CarHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCar.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Car' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCar.glb');
