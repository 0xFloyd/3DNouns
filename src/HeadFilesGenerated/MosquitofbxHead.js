...
const MosquitofbxHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMosquitofbx.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Mosquitofbx' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/HeadMosquitofbx.glb');

export default MosquitofbxHead;
