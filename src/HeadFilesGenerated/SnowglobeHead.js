...
const SnowglobeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSnowglobe.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Snowglobe' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSnowglobe.glb');

export default SnowglobeHead;
