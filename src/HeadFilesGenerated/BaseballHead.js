...
const BaseballHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBaseball.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Baseball-Gameball' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBaseball.glb');

export default BaseballHead;
