...
const PeanutHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPeanut.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Peanut' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPeanut.glb');

export default PeanutHead;
