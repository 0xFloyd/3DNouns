...
const RangefinderHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Rangefinder' ? true : false} castShadow receiveShadow>
