...
const GarlicHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadGarlic.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Garlic' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadGarlic.glb');

export default GarlicHead;
