...
const GoldcoinHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadGoldcoin.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Goldcoin' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadGoldcoin.glb');

export default GoldcoinHead;
