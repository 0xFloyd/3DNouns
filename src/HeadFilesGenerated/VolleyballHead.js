...
const VolleyballHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadVolleyBall.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Volleyball' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadVolleyBall.glb');

export default VolleyballHead;
