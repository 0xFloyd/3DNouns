...
const VoidHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadVoid.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Void' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadVoid.glb');

export default VoidHead;
