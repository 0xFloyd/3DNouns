...
const TacoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadTaco.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Taco-Classic' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadTaco.glb');

export default TacoHead;
