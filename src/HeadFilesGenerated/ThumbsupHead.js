...
const ThumbsupHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadThumbsUp.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Thumbsup' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadThumbsUp.glb');

export default ThumbsupHead;
