...
const MugHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMug.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Mug' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadMug.glb');
