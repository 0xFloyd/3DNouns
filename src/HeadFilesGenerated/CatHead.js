...
const CatHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/catHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cat' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/catHead.glb');
