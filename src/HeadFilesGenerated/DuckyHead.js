...
const DuckyHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadDucky.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Ducky' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadDucky.glb');
