...
const HorsedeepfriedHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadHorseDeepFried.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Horse-Deepfried' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadHorseDeepFried.glb');

export default HorsedeepfriedHead;
