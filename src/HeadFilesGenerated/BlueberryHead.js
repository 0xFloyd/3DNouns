...
const BlueberryHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBlueberry.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Blueberry' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBlueberry.glb');

export default BlueberryHead;
