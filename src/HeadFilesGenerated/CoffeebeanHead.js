...
const CoffeebeanHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCoffeebean.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Coffeebean' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCoffeebean.glb');

export default CoffeebeanHead;
