...
const PinappleHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/pinappleHead.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Pinapple' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/pinappleHead.glb');

export default PinappleHead;
