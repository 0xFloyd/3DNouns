...
const CottonballHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCottonBall.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cottonball' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCottonBall.glb');

export default CottonballHead;
