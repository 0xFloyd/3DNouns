...
const MosquitoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMosquito.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Mosquito' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadMosquito.glb');

export default MosquitoHead;
