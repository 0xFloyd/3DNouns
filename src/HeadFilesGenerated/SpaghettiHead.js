...
const SpaghettiHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSpaghetti.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Spaghetti' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSpaghetti.glb');

export default SpaghettiHead;
