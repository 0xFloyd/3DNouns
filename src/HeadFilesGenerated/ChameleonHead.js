...
const ChameleonHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadChameleon.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Chameleon' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadChameleon.glb');

export default ChameleonHead;
