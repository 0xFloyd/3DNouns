...
const DoughnutHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadDoughnut.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Doughnut' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadDoughnut.glb');

export default DoughnutHead;
