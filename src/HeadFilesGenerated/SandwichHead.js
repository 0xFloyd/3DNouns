...
const SandwichHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/sandwichHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Sandwich' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/sandwichHead.glb');

export default SandwichHead;
