...
const ApeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadApe.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Ape' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadApe.glb');

export default ApeHead;
