...
const BlackholeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBlackhole.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Blackhole' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBlackhole.glb');

export default BlackholeHead;
