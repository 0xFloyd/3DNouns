...
const PipeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPipe.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pipe' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPipe.glb');
