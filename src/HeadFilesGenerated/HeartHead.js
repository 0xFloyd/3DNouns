...
const HeartHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/heartHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Heart' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/heartHead.glb');
