...
const SawHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSaw.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Saw' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSaw.glb');

export default SawHead;
