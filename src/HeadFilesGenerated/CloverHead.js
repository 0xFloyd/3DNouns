...
const CloverHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/cloverHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Clover' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/cloverHead.glb');

export default CloverHead;
