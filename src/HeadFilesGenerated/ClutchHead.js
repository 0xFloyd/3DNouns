...
const ClutchHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadClutch.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Clutch' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadClutch.glb');

export default ClutchHead;
