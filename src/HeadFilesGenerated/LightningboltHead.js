...
const LightningboltHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadLightningBolt.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Lightning-Bolt' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadLightningBolt.glb');

export default LightningboltHead;
