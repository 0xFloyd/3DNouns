...
const JupiterHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadJupiter.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Jupiter' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadJupiter.glb');
