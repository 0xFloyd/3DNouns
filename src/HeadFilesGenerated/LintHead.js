...
const LintHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadLint.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Lint' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadLint.glb');

export default LintHead;
