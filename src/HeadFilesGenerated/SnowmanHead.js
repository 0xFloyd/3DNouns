...
const SnowmanHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/SnowmanHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Snowman' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/SnowmanHead.glb');
