...
const SunsetHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/sunsetHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Sunset' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/sunsetHead.glb');

export default SunsetHead;
