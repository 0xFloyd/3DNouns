...
const HangerHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HangerHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Hanger' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HangerHead.glb');

export default HangerHead;
