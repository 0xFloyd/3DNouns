...
const BeetHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBeet.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Beet' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBeet.glb');

export default BeetHead;
