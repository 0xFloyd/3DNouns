...
const LipsHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadLips.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Lips' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadLips.glb');
