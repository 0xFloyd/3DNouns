...
const BananaHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBanana.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Banana' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBanana.glb');

export default BananaHead;
