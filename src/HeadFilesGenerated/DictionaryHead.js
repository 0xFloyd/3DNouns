...
const DictionaryHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadDictionary.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Dictionary' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadDictionary.glb');
