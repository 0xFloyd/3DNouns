...
const OtterHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadOtter.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Otter' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadOtter.glb');

export default OtterHead;
