...
const ComputerHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadComputer.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Computer' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/HeadComputer.glb');

export default ComputerHead;
