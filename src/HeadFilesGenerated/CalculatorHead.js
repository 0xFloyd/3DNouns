...
const CalculatorHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCalculator.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Calculator' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCalculator.glb');
