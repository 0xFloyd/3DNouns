...
const OysterHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadOyster.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Oyster' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadOyster.glb');

export default OysterHead;
