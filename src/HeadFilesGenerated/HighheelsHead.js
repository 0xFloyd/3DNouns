...
const HighheelsHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadHighHeels.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Highheel' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadHighHeels.glb');

export default HighheelsHead;
