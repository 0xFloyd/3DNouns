...
const CraneHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCrane.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Crane' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCrane.glb');
