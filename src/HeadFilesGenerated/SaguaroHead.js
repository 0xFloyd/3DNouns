...
const SaguaroHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSaguaro.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Saguaro' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSaguaro.glb');

export default SaguaroHead;
