...
const RgbHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRGB.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Rgb' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRGB.glb');

export default RgbHead;
