...
const BigfootyetiHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bigfoot-Yeti' ? true : false} castShadow receiveShadow>
...
export default BigfootyetiHead;
