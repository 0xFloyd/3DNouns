...
const KangarooHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadKangaroo.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Kangaroo' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadKangaroo.glb');

export default KangarooHead;
