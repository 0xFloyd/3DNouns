...
const DinoHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadDino.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Dino' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadDino.glb');

export default DinoHead;
