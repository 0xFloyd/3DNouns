...
const PlaneHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPlane.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Plane' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPlane.glb');
