...
const FanHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadFan.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Fan' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadFan.glb');
