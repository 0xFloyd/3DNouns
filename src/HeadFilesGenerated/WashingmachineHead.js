...
const WashingmachineHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWashingMachine.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Washingmachine' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWashingMachine.glb');

export default WashingmachineHead;
