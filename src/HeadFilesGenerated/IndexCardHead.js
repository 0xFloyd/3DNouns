...
const IndexCardHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/IndexCardHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Index-Card' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/IndexCardHead.glb');
