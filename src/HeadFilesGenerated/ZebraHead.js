...
const ZebraHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadZebra.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Zebra' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadZebra.glb');

export default ZebraHead;
