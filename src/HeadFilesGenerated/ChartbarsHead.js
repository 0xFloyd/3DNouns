...
const ChartbarsHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadChartBars.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Chart-Bars' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadChartBars.glb');

export default ChartbarsHead;
