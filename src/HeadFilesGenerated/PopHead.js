...
const PopHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPop.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pop' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPop.glb');
