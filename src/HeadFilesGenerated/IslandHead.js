...
const IslandHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadIsland.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Island' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadIsland.glb');

export default IslandHead;
