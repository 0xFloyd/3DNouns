...
const FabergeHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadFaberge.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Faberge' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadFaberge.glb');

export default FabergeHead;
