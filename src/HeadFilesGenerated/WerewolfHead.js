...
const WerewolfHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWerewolf.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Werewolf' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWerewolf.glb');

export default WerewolfHead;
