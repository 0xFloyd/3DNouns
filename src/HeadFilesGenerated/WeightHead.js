...
const WeightHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWeight.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Weight' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWeight.glb');

export default WeightHead;
