...
const RavenHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRaven.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Raven' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRaven.glb');

export default RavenHead;
