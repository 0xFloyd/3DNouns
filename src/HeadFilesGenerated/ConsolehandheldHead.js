...
const ConsolehandheldHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Console-Handheld' ? true : false} castShadow receiveShadow>
...
export default ConsolehandheldHead;
