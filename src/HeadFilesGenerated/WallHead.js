...
const WallHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWall.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Wall' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWall.glb');
