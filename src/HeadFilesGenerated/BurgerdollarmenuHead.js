...
const BurgerdollarmenuHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBurgerDollarMenu.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Burger-Dollarmenu' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBurgerDollarMenu.glb');

export default BurgerdollarmenuHead;
