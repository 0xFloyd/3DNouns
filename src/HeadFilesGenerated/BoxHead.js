...
const BoxHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBox.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Box' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBox.glb');
