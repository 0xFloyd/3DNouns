...
const PencilHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPencil.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pencil-Tip' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPencil.glb');

export default PencilHead;
