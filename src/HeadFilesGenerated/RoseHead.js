...
const RoseHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadRose.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Rosebud' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadRose.glb');

export default RoseHead;
