...
const CassetteHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/cassetteHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cassettetape' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/cassetteHead.glb');

export default CassetteHead;
