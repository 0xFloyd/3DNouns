...
const BubblespeechHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadBubbleSpeech.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Bubble-Speech' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadBubbleSpeech.glb');

export default BubblespeechHead;
