...
const MagichatHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMagicHat.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Magichat' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/HeadMagicHat.glb');

export default MagichatHead;
