...
const SmileHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSmile.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Smile' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadSmile.glb');

export default SmileHead;
