...
const PeyoteHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPeyote.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Peyote' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPeyote.glb');

export default PeyoteHead;
