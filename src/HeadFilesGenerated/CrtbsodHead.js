...
const CrtbsodHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCrtBsod.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Crt-Bsod' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCrtBsod.glb');

export default CrtbsodHead;
