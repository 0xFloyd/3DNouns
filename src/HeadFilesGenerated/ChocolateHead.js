...
const ChocolateHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadChocolate.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Chocolate' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadChocolate.glb');

export default ChocolateHead;
