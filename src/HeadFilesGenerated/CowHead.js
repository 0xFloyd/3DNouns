...
const CowHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadCow.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Cow' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadCow.glb');
