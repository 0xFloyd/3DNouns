...
const DnaHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/DNAHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Dna' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/DNAHead.glb');

export default DnaHead;
