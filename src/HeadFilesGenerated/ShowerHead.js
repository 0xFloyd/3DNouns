...
const ShowerHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadShower.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Shower' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadShower.glb');
