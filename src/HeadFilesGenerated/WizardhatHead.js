...
const WizardhatHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWizardHat.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Wizardhat' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWizardHat.glb');
