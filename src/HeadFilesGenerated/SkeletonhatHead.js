...
const SkeletonhatHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Skeleton-Hat' ? true : false} castShadow receiveShadow>
