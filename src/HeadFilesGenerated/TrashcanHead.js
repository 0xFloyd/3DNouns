...
const TrashcanHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/trashcanHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Trashcan' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/trashcanHead.glb');

export default TrashcanHead;
