...
const SnowballHead = ({
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadSnowball.glb');
  ...
  return (
    <group
      ref={group}
      dispose={null}
      visible={headProp === 'Snowball' ? true : false}
      castShadow
      receiveShadow
    >
      <primitive
...
useGLTF.preload('/headModels/HeadSnowball.glb');

export default SnowballHead;
