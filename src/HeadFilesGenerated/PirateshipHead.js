...
const PirateshipHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/pirateshipHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pirateship' ? true : false} castShadow receiveShadow>
