...
const PillowHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadPillow.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Pillow' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadPillow.glb');

export default PillowHead;
