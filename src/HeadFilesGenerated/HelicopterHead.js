...
const HelicopterHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HelicopterHead.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Helicopter' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HelicopterHead.glb');

export default HelicopterHead;
