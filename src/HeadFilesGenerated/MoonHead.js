...
const MoonHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadMoon.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Moon' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadMoon.glb');

export default MoonHead;
