...
const WalletHead = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/HeadWallet.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'Wallet' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/HeadWallet.glb');
