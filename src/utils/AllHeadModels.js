...
export const headComponents = [
  ...
  { name: 'Ape', value: ApeHead },
  { name: 'Bag', value: BagHead },
  { name: 'Bagpipe', value: BagpipeHead },
  { name: 'Banana', value: BananaHead },
  { name: 'Bank', value: BankHead },
  { name: 'Baseball', value: BaseballHead },
  { name: 'Basketball', value: BasketballHead },
  { name: 'Bat', value: BatHead },
  { name: 'Bear', value: BearHead },
  { name: 'Beer', value: BeerHead },
  { name: 'Beet', value: BeetHead },
  { name: 'Bell', value: BellHead },
  { name: 'Bigfoot', value: BigfootHead },
  { name: 'Bigfootyeti', value: BigfootyetiHead },
  { name: 'Blackhole', value: BlackholeHead },
  { name: 'Blueberry', value: BlueberryHead },
  { name: 'Bomb', value: BombHead },
  { name: 'Bonsai', value: BonsaiHead },
  { name: 'Boombox', value: BoomboxHead },
  { name: 'Boot', value: BootHead },
  { name: 'Box', value: BoxHead },
  { name: 'Boxingglove', value: BoxinggloveHead },
  { name: 'Brain', value: BrainHead },
  { name: 'Bubblegum', value: BubblegumHead },
  { name: 'Bubblespeech', value: BubblespeechHead },
  { name: 'Burgerdollarmenu', value: BurgerdollarmenuHead },
  { name: 'Cake', value: CakeHead },
  { name: 'Calculator', value: CalculatorHead },
  { name: 'Calendar', value: CalendarHead },
  ...
  { name: 'Chain', value: ChainHead },
  { name: 'Chainsaw', value: ChainsawHead },
  { name: 'Chameleon', value: ChameleonHead },
  { name: 'Chartbars', value: ChartbarsHead },
  { name: 'Cheese', value: CheeseHead },
  { name: 'Chefhat', value: ChefhatHead },
  { name: 'Cherry', value: CherryHead },
  { name: 'Chicken', value: ChickenHead },
  { name: 'Chili', value: ChiliHead },
  { name: 'Chipboard', value: ChipboardHead },
  { name: 'Chips', value: ChipsHead },
  { name: 'Chocolate', value: ChocolateHead },
  { name: 'Cloud', value: CloudHead },
  { name: 'Clover', value: CloverHead },
  { name: 'Clutch', value: ClutchHead },
  { name: 'Coffeebean', value: CoffeebeanHead },
  { name: 'Cone', value: ConeHead },
  { name: 'Consolehandheld', value: ConsolehandheldHead },
  { name: 'Cookie', value: CookieHead },
  { name: 'Cordlessphone', value: CordlessphoneHead },
  { name: 'Cottonball', value: CottonballHead },
  { name: 'Cow', value: CowHead },
  { name: 'Crab', value: CrabHead },
  { name: 'Crane', value: CraneHead },
  { name: 'Crochat', value: CrochatHead },
  { name: 'Crown', value: CrownHead },
  { name: 'Crtbsod', value: CrtbsodHead },
  { name: 'Crystalball', value: CrystalballHead },
  ...
  { name: 'Dna', value: DnaHead },
  { name: 'Dog', value: DogHead },
  { name: 'Doughnut', value: DoughnutHead },
  { name: 'Drill', value: DrillHead },
  { name: 'Duck', value: DuckHead },
  { name: 'Ducky', value: DuckyHead },
  { name: 'Earth', value: EarthHead },
  { name: 'Eggs', value: EggsHead },
  { name: 'Faberge', value: FabergeHead },
  { name: 'Factory', value: FactoryHead },
  { name: 'Fan', value: FanHead },
  { name: 'Fence', value: FenceHead },
  { name: 'Film35Mm', value: Film35MmHead },
  { name: 'Filmstrip', value: FilmstripHead },
  { name: 'Fir', value: FirHead },
  { name: 'Firehydrant', value: FirehydrantHead },
  { name: 'Flamingo', value: FlamingoHead },
  { name: 'Flower', value: FlowerHead },
  { name: 'Fox', value: FoxHead },
  { name: 'Frog', value: FrogHead },
  { name: 'Garlic', value: GarlicHead },
  { name: 'Gavel', value: GavelHead },
  { name: 'Ghost', value: GhostHead },
  { name: 'Glasses', value: GlassesHead },
  { name: 'Gnome', value: GnomeHead },
  { name: 'Goat', value: GoatHead },
  { name: 'Goldcoin', value: GoldcoinHead },
  { name: 'Goldfish', value: GoldfishHead },
  { name: 'Grouper', value: GrouperHead },
  { name: 'Hair', value: HairHead },
  { name: 'Hardhat', value: HardhatHead },
  { name: 'Heart', value: HeartHead },
  { name: 'Helicopter', value: HelicopterHead },
  { name: 'Highheels', value: HighheelsHead },
  { name: 'Hockeypuck', value: HockeypuckHead },
  { name: 'Horsedeepfried', value: HorsedeepfriedHead },
  { name: 'Hotdog', value: HotdogHead },
  { name: 'House', value: HouseHead },
  { name: 'Icepop', value: IcepopHead },
  { name: 'Igloo', value: IglooHead },
  { name: 'Island', value: IslandHead },
  { name: 'Jellyfish', value: JellyfishHead },
  { name: 'Jupiter', value: JupiterHead },
  { name: 'Kangaroo', value: KangarooHead },
  { name: 'Ketchup', value: KetchupHead },
  { name: 'Laptop', value: LaptopHead },
  { name: 'Lightningbolt', value: LightningboltHead },
  { name: 'Lint', value: LintHead },
  { name: 'Lips', value: LipsHead },
  { name: 'Lipstick', value: LipstickHead },
  { name: 'Lock', value: LockHead },
  { name: 'Macaroni', value: MacaroniHead },
  { name: 'Mailbox', value: MailboxHead },
  { name: 'Maze', value: MazeHead },
  { name: 'Microwave', value: MicrowaveHead },
  { name: 'Milk', value: MilkHead },
  { name: 'Mirror', value: MirrorHead },
  { name: 'Mixer', value: MixerHead },
  { name: 'Moon', value: MoonHead },
  { name: 'Moose', value: MooseHead },
  { name: 'Mosquito', value: MosquitoHead },
  { name: 'Mountain', value: MountainHead },
  { name: 'Mouse', value: MouseHead },
  { name: 'Mug', value: MugHead },
  { name: 'Mushroom', value: MushroomHead },
  { name: 'Mustard', value: MustardHead },
  { name: 'Nigiri', value: NigiriHead },
  { name: 'Noodles', value: NoodlesHead },
  { name: 'Onion', value: OnionHead },
  { name: 'Orangutan', value: OrangutanHead },
  { name: 'Orca', value: OrcaHead },
  { name: 'Otter', value: OtterHead },
  { name: 'Outlet', value: OutletHead },
  { name: 'Owl', value: OwlHead },
  { name: 'Oyster', value: OysterHead },
  { name: 'Paintbrush', value: PaintbrushHead },
  { name: 'Panda', value: PandaHead },
  { name: 'Paperclip', value: PaperclipHead },
  { name: 'Peanut', value: PeanutHead },
  { name: 'Pencil', value: PencilHead },
  { name: 'Peyote', value: PeyoteHead },
  { name: 'Piano', value: PianoHead },
  { name: 'Pickle', value: PickleHead },
  { name: 'Pie', value: PieHead },
  { name: 'Piggybank', value: PiggybankHead },
  { name: 'Pill', value: PillHead },
  { name: 'Pillow', value: PillowHead },
  { name: 'Pineapple', value: PineappleHead },
  { name: 'Pipe', value: PipeHead },
  { name: 'Pirateship', value: PirateshipHead },
  { name: 'Pizza', value: PizzaHead },
  { name: 'Plane', value: PlaneHead },
  { name: 'Pop', value: PopHead },
  { name: 'Porkbao', value: PorkbaoHead },
  { name: 'Potato', value: PotatoHead },
  { name: 'Pufferfish', value: PufferfishHead },
  { name: 'Pumpkin', value: PumpkinHead },
  { name: 'Pyramid', value: PyramidHead },
  { name: 'Queencrown', value: QueencrownHead },
  { name: 'Rabbit', value: RabbitHead },
  { name: 'Rainbow', value: RainbowHead },
  { name: 'Rangefinder', value: RangefinderHead },
  { name: 'Raven', value: RavenHead },
  { name: 'Retainer', value: RetainerHead },
  { name: 'Rgb', value: RgbHead },
  { name: 'Ring', value: RingHead },
  { name: 'Road', value: RoadHead },
  { name: 'Robot', value: RobotHead },
  { name: 'Rock', value: RockHead },
  { name: 'Rose', value: RoseHead },
  { name: 'Rulertriangular', value: RulertriangularHead },
  { name: 'Saguaro', value: SaguaroHead },
  { name: 'Sailboat', value: SailboatHead },
  { name: 'Sandwich', value: SandwichHead },
  { name: 'Saturn', value: SaturnHead },
  { name: 'Saw', value: SawHead },
  { name: 'Scorpion', value: ScorpionHead },
  { name: 'Shark', value: SharkHead },
  { name: 'Shower', value: ShowerHead },
  { name: 'Skate', value: SkateHead },
  { name: 'Skeletonhat', value: SkeletonhatHead },
  { name: 'Skilift', value: SkiliftHead },
  { name: 'Smile', value: SmileHead },
  { name: 'Snowglobe', value: SnowglobeHead },
  { name: 'Snowmobile', value: SnowmobileHead },
  { name: 'Spaghetti', value: SpaghettiHead },
  { name: 'Sponge', value: SpongeHead },
  { name: 'Squid', value: SquidHead },
  { name: 'Stapler', value: StaplerHead },
  { name: 'Starsparkle', value: StarsparkleHead },
  { name: 'Steak', value: SteakHead },
  { name: 'Sunset', value: SunsetHead },
  { name: 'Taco', value: TacoHead },
  { name: 'Taxi', value: TaxiHead },
  { name: 'Thumbsup', value: ThumbsupHead },
  { name: 'Toaster', value: ToasterHead },
  { name: 'Toiletpaper', value: ToiletpaperHead },
  { name: 'Tooth', value: ToothHead },
  { name: 'Toothbrush', value: ToothbrushHead },
  { name: 'Tornado', value: TornadoHead },
  { name: 'Trashcan', value: TrashcanHead },
  { name: 'Turing', value: TuringHead },
  { name: 'Ufo', value: UfoHead },
  { name: 'Undead', value: UndeadHead },
  { name: 'Unicorn', value: UnicornHead },
  { name: 'Vent', value: VentHead },
  { name: 'Void', value: VoidHead },
  { name: 'Volcano', value: VolcanoHead },
  { name: 'Volleyball', value: VolleyballHead },
  { name: 'Wall', value: WallHead },
  { name: 'Wallet', value: WalletHead },
  { name: 'Wallsafe', value: WallsafeHead },
  { name: 'Washingmachine', value: WashingmachineHead },
  { name: 'Watch', value: WatchHead },
  { name: 'Watermelon', value: WatermelonHead },
  { name: 'Wave', value: WaveHead },
  { name: 'Weed', value: WeedHead },
  { name: 'Weight', value: WeightHead },
  { name: 'Werewolf', value: WerewolfHead },
  { name: 'Whale', value: WhaleHead },
  { name: 'Whalealive', value: WhalealiveHead },
