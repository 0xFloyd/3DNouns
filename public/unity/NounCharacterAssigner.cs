...
/// Creates a prefab from Nouns base models. Created as a fix for https://3dnouns.com/ characters.
/// 
...
/// 1-Download the base body.glb and head.glb from https://github.com/0xFloyd/3DNouns/tree/main/public/baseModels

/// 2-Import them into Unity.

/// 3-Create a main Nouns gameobject prefab that is structured as so:
///    - Parent: Empty Placeholder (Make the name be "MAIN")
///         -Children:
///             - gameobject of the body.glb
///             - gameobject of the head.glb

/// 4-Go to https://3dnouns.com/ and download as many created characters as you want.

/// 5-Import the downloaded Nouns character .gltf files into Unity.

/// 6-Place the created "MAIN" prefab in the same location as the imported .gltf models

/// 7-Select all of the .gltf models you want to convert and the "MAIN" noun model. If they are in a lone folder you can do Ctrl+A.

/// 8-At the top bar in Unity go to Custom Tools>MakeNounPrefabs and click it.
