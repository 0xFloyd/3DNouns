...
const HeadComponent = ({ headProp, glassesProp, animationState, animationValue, masterHeadModel }) => {
  const group = useRef();
  const { nodes, materials } = useGLTF('/headModels/filePlaceholderName.glb');
  ...
  return (
    <group ref={group} dispose={null} visible={headProp === 'HeadVariableName' ? true : false} castShadow receiveShadow>
...
// useGLTF.preload('/headModels/filePlaceholderName.glb');
